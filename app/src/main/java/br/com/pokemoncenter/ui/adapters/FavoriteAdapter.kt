...
class PokemonCardAdapter : ListAdapter<FavoritesEntity, PokemonCardAdapter.PokemonCardViewHolder>(DiffCallback()) {
    ...
    private var cardListener: PokemonNameListener? = null

    fun setCardListener(listener: PokemonNameListener) {
        this.cardListener = listener
    }

    class PokemonCardViewHolder(view: View, cardListener: PokemonNameListener?) :
